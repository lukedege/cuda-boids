...
{
	gpu_ssbo_monolithic::gpu_ssbo_monolithic(simulation_parameters params) :
		ssbo_runner{ params },
	...
	void gpu_ssbo_monolithic::naive_calculation(const float delta_time)
	{
	...
	void gpu_ssbo_monolithic::uniform_grid_calculation(const float delta_time) 
	{
	...
	void gpu_ssbo_monolithic::coherent_grid_calculation(const float delta_time) 
	{
		namespace bhvr = behaviours;
	...
	void gpu_ssbo_monolithic::calculate(const float delta_time)
	{
	...
	void gpu_ssbo_monolithic::draw(const glm::mat4& view_matrix, const glm::mat4& projection_matrix)
	{
	...
	gpu_ssbo_monolithic::~gpu_ssbo_monolithic()
	{
	...
	gpu_ssbo_monolithic::simulation_parameters gpu_ssbo_monolithic::get_simulation_parameters()
	{
		return sim_params;
	}

	void gpu_ssbo_monolithic::set_dynamic_simulation_parameters(simulation_parameters::dynamic_parameters new_dyn_params)
	{
