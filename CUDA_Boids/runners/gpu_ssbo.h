...
namespace utils::runners
{
	...
	private:
		...
		// TODO to remove before final draft
		void naive_calculation_modular        (const float delta_time);
		void uniform_grid_calculation_modular (const float delta_time);
		void coherent_grid_calculation_modular(const float delta_time);
